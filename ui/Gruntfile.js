...
module.exports = function(grunt) {
    ...
    grunt.registerTask('serve', ['dom_munger:read', 'jshint', 'configureProxies:dev', 'connect:main', 'connect:dev', 'watch']);
    ...
    grunt.event.on('watch', function(action, filepath) {
        ...
        if (filepath.lastIndexOf('.js') !== -1 && filepath.lastIndexOf('.js') === filepath.length - 3) {
            ...
            var spec = filepath;
            if (filepath.lastIndexOf('-spec.js') === -1 || filepath.lastIndexOf('-spec.js') !== filepath.length -
                8) {
